...
<script type="text/javascript">
	...
	$.categoryAddAction = function() {
		console.log("눌렀다.");
		console.log("Code : " + code);
		var text = $("#categoryAddText").val();
		$("#categoryAddText").val("");
		if(text == "") {
			console.log("빈칸없이 입력하시요");
		}
		else {
			console.log("입력 값 : " + text);
			$.ajax({
				type: "GET",
				...
				success: (data) => {
					console.log("추가되었습니다");
					//location.href = "${pageContext.request.contextPath}/category/main";
					$.showSelectBoxTop();
				}
			});
		}
